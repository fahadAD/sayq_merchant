class CompletedDeliveryModel {
  CompletedDeliveryModel({
    bool? success,
    String? message,
    Data? data,}){
    _success = success;
  ...
  CompletedDeliveryModel.fromJson(dynamic json) {
...
class Data {
  Data({
    List<CompletedDelivery>? parcels,}){
    _parcels = parcels;
  }
  ...
  Data.fromJson(dynamic json) {
    if (json['parcels'] != null) {
      ...
      json['parcels'].forEach((v) {
        _parcels?.add(CompletedDelivery.fromJson(v));
      });
    }
  }
  List<CompletedDelivery>? _parcels;

  List<CompletedDelivery>? get parcels => _parcels;
...
class CompletedDelivery {
  ...
  CompletedDelivery.fromJson(dynamic json) {
    _id = json['id'];
