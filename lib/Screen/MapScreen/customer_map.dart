        ...
        children: [
          PlacePicker(
            ...
            onCameraMove: (position) {
              parcelController.customer_Lat.value = position.target.latitude;
              parcelController.customer_Long.value = position.target.longitude;
              ...
              print('============ longitude not data=============${parcelController.customer_Lat.value=position.target.latitude}===========');
              print('============ longitude not data=============${parcelController.customer_Long.value = position.target.longitude}===========');
