...
class CustomerMapsScreen extends StatefulWidget {
  const CustomerMapsScreen({super.key});

  @override
  State<CustomerMapsScreen> createState() => _CustomerMapsScreenState();
}

class _CustomerMapsScreenState extends State<CustomerMapsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Select Customer  location'),
      ),
              ...
              children: [
                PlacePicker(
                  ...
                  onCameraMove: (position) {
                    parcelController.customer_Lat.value = position.target.latitude.toString();
                    parcelController.customer_Long.value = position.target.longitude.toString();
                    ...
                    print('============ longitude not data=============${parcelController.customer_Lat.value = position.target.latitude.toString()}===========');
                    print('============ longitude not data=============${parcelController.customer_Long.value = position.target.longitude.toString()}===========');
                  },
                            ...
                            child: Column(
                              children: [
                                ...
                                ElevatedButton(
                                  ...
                                  onPressed: () {
                                    setState(() {
                                      parcelController.customerAddress = result.formattedAddress!.toString();
                                    });
