  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<BalanceController>(
          ...
          builder: (balanceController) =>RefreshIndicator(
            displacement: 40,
            ...
            child: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Container(
                    child: balanceController.loader
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${balanceController.balanceDetails.amountDelivered!.toStringAsFixed(2)}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        color: kTitleColor,
                                        fontWeight: FontWeight.w500,
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Payable Delivery Charge",
                                      style: TextStyle(
                                        fontSize: 15,
                                        color: kTitleColor,
                                        fontWeight: FontWeight.w500,
                                      )),
                                  Text("${balanceController.balanceDetails.payableDeliveryCharge!.toStringAsFixed(2)}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        color: kTitleColor,
                                        fontWeight: FontWeight.w500,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${balanceController.balanceDetails.subTotal!.toStringAsFixed(2)}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        color: kTitleColor,
                                        fontWeight: FontWeight.w500,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${balanceController.balanceDetails.codCharge!.toStringAsFixed(2)}",
                                      style: TextStyle(
                                        fontSize: 15,
                                        color: kTitleColor,
                                        fontWeight: FontWeight.w500,
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${balanceController.balanceDetails.availableBalance!.toStringAsFixed(2)}",
                                      style: TextStyle(
                                        fontSize: 17,
                                        color: kTitleColor,
                                        fontWeight: FontWeight.bold,
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(5), border: Border.all(color: Colors.green, width: 2)),
                                  child: Text("Cleanable Parcels (${balanceController.balanceDetails.clearableParcels})",
                        ...
                        balanceController.balanceDetails.availableBalance == 0.0
                            ? SizedBox.shrink()
                            : ButtonGlobal(
